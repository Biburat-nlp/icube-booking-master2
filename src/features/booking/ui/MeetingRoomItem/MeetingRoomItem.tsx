...
import type { AnyReservation, TMeetingRoomReservation } from "@/features/booking/types/reservations.ts";
...
import styles from "./MeetingRoomItem.module.scss";
...
export const MeetingRoomItem = ({
    ...
    webinar?: TMeetingRoomReservation["webinar"];
    cb: (arg: any) => void;
}) => {
    ...
    const handleCancel = () => {
        cb({ id, target_id, type: "cancelBook" });
    };

    const handleUpdate = () => {
        cb({ id, target_id, type: "updateBookMeetingRoom" });
    };
    ...
    return (
        <div className={styles.card}>
                ...
                {isActive ? (
                    <>
                        ...
                        <span className={styles.durationTime}>
                            {formatTimeDuration({ start: Date.now(), end: reserve_end }, fnsLocale, "minutes")}
                        </span>
                    </>
                ) : (
            ...
            <div className={styles.meetingSubject}>{meeting_subject}</div>
